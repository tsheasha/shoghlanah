...
class Notice(models.Model):
    ...
    message_arabic = models.TextField(_("arabic message"))
    notice_type = models.ForeignKey(NoticeType, verbose_name=_("notice type"))
...
def send_now(users, sender, label, the_message, message_arabic, the_link, extra_context=None, on_site=True):
    """
    ...
    for user in users:
        ...
        notice = Notice.objects.create(recipient=user, message=the_message, message_arabic=message_arabic, notice_type=notice_type, link=the_link, on_site=on_site, sender=sender)
